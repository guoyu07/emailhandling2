...
session_start(); 
$jsonData2= $_SESSION['jsontext2'];
$jsonArr2 = json_decode($jsonData2);
...
<div id="header">
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    <li><a href="websitedraft.php"><span>All Emails</span></a></li>
			    <li><a href="#" class="active"><span>Student Log</span></a></li>
				...
				<div class="box">
					...
					<div class="box-head">
						...
						<div class="right">
							...
							<form action="searchEmail.php" method="get">
							<label>search by banner</label>
							<input type="text" name="SearchItem" class="field small-field" />
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								foreach ($phpArray2 as $key => $value)
								{ 
									if($count % 2)
										echo '<tr>';
									else
									...
									echo $key;
									echo '">';
									echo  $phpArray2[$key]['emailaddress'];
									echo ' </a>';
